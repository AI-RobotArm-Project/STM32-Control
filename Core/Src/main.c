...
DcPIND_11ON();
DcPIND_12ON();
for (int i=0; i<35; i++)   // for 360 deg rotation
   {
...
for (int i=0; i<35; i++)   // for 360 deg rotation
 ...
 HAL_GPIO_WritePin (GPIOE, GPIO_PIN_10, GPIO_PIN_RESET);
 HAL_GPIO_WritePin (GPIOE, GPIO_PIN_12, GPIO_PIN_RESET);   // IN2 HIGH
 ...
 HAL_GPIO_WritePin (GPIOE, GPIO_PIN_14, GPIO_PIN_RESET);   // IN3 HIGH
 HAL_GPIO_WritePin (GPIOE, GPIO_PIN_15, GPIO_PIN_RESET);
 ...
 HAL_GPIO_WritePin (GPIOE, GPIO_PIN_12, GPIO_PIN_RESET);
 HAL_GPIO_WritePin (GPIOE, GPIO_PIN_14, GPIO_PIN_RESET);
 HAL_GPIO_WritePin (GPIOE, GPIO_PIN_15, GPIO_PIN_RESET);    // IN4 HIGH
  
 HAL_Delay (2); 
 }
HAL_Delay(2000);
PCA9685_SetServoAngle(1, 115);
HAL_Delay(2000);
PCA9685_SetServoAngle(0, 10);
HAL_Delay(2000);
PCA9685_SetServoAngle(1, 157);
HAL_Delay(2000);
PCA9685_SetServoAngle(1, 115);
HAL_Delay(2000);
PCA9685_SetServoAngle(1, 65);
HAL_Delay(2000);
PCA9685_SetServoAngle(10, 65);
HAL_Delay(2000);
PCA9685_SetServoAngle(1, 105);
HAL_Delay(2000);
PCA9685_SetServoAngle(0, 55);
HAL_Delay(2000);
PCA9685_SetServoAngle(1, 115);
HAL_Delay(2000);
...
TIM9->CCR1 = 2900;
		  PCA9685_SetServoAngle(1, 120);
			HAL_Delay(500);
			HAL_GPIO_WritePin(GPIOE,GPIO_PIN_2,0); // AIN -> 0 // dc sipza driver
      HAL_GPIO_WritePin(GPIOE,GPIO_PIN_3,1);
	    HAL_Delay(500);
	    PCA9685_SetServoAngle(1, 122);
			HAL_Delay(500);
			HAL_GPIO_WritePin(GPIOE,GPIO_PIN_2,0); // AIN -> 0 // dc sipza driver
      HAL_GPIO_WritePin(GPIOE,GPIO_PIN_3,1);
	    HAL_Delay(500);
	    PCA9685_SetServoAngle(1, 124);
			HAL_Delay(500);
			HAL_GPIO_WritePin(GPIOE,GPIO_PIN_2,0); // AIN -> 0 // dc sipza driver
      HAL_GPIO_WritePin(GPIOE,GPIO_PIN_3,1);
	    HAL_Delay(500);
			PCA9685_SetServoAngle(1, 126);
			HAL_Delay(500);
			HAL_GPIO_WritePin(GPIOE,GPIO_PIN_2,0); // AIN -> 0 // dc sipza driver
      HAL_GPIO_WritePin(GPIOE,GPIO_PIN_3,1);
	    HAL_Delay(500);
			PCA9685_SetServoAngle(1, 128);
			HAL_Delay(500);
			HAL_GPIO_WritePin(GPIOE,GPIO_PIN_2,0); // AIN -> 0 // dc sipza driver
      HAL_GPIO_WritePin(GPIOE,GPIO_PIN_3,1);
	    HAL_Delay(500);
			HAL_GPIO_WritePin(GPIOE,GPIO_PIN_2,1); // AIN -> 0 // dc sipza driver
      HAL_GPIO_WritePin(GPIOE,GPIO_PIN_3,1);
			HAL_Delay(2000);
